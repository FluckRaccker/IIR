...
# ACDS 20.1 711 win32 2026.05.08.14:41:07
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_led_pio.vhd"             -work led_pio             -cdslib ./cds_libs/led_pio.cds.lib            
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_f2sdram_only_master.vhd" -work f2sdram_only_master -cdslib ./cds_libs/f2sdram_only_master.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_dipsw_pio.vhd"           -work dipsw_pio           -cdslib ./cds_libs/dipsw_pio.cds.lib          
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_button_pio.vhd"          -work button_pio          -cdslib ./cds_libs/button_pio.cds.lib         
