...
# ACDS 20.1 711 win32 2026.03.10.12:29:09
...
# ----------------------------------------
# If PLL12M288 is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLL12M288.vo"
fi
